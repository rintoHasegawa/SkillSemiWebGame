...
| ファイル | 方針 | 理由 | 記録日 |
| --- | --- | --- | --- |
| `docs/01_GUIDE/GUIDE_03_チーム開発ルール.md` | merge | CI を構築したため，同ガイドの指示（「CI 構築後はこの節を削除する」）に従い「CI 構築までの暫定ゲート」節と管理者初期設定の「CI の構築」項目を削除した | 2026-09-17 |
| `.claude/skills/setup/SKILL.md` | merge | 上記で GUIDE_03 から削除した「CI 構築までの暫定ゲート」への参照を除去した（参照先が存在しないため） | 2026-09-17 |
