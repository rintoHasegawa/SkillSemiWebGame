...
const CLIENT_GAME_CONFIG = {
  ...
  PLAYER_HIT_BLINK_MS: sharedConfig.GAME_CONFIG.PLAYER_HIT_STUN_MS,
  PLAYER_HIT_BLINK_INTERVAL_MS: 100,
  PLAYER_HIT_BLINK_HIDDEN_ALPHA: 0.2,
  PLAYER_HIT_BLINK_MAX_DELTA_MS: 50,
  PLAYER_HIT_EFFECT_DEDUP_WINDOW_MS: 300,
